...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { start_signal }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { mode[2] }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { D1[0] }]; #IO_L18P_T2_A24_15 Sch=led[0]
